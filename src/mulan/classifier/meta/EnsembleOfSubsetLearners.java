...
/**
 * <!-- globalinfo-start -->
 * A class for gathering several different SubsetLearners into a composite
 * ensemble model. &lt;br&gt; &lt;br&gt; The label set partitions for
 * participation in ensemble are selected using their dependence weight from the
 * large number of randomly generated possible partitions. The type of the
 * learned dependencies is determined by the {&#64;link
 * mulan.data.LabelPairsDependenceIdentifier} supplied to the class constructor.
 * Two strategies for selecting ensemble partitions exists: (1) to select the
 * highly weighted ones and (2) to select most different from the highly
 * weighted ones. The strategy to be used is determined by the {&#64;link
 * #selectDiverseModels} parameter which is 'true' by default.<br>
 * <br>
 * For more information, see<br>
 * <br>
 * Lena Tenenboim-Chekina, Lior Rokach,, Bracha Shapira: Identification of Label
 * Dependencies for Multi-label Classification. In: , Haifa, Israel, 53--60,
 * 2010.
 * <br>
 * <!-- globalinfo-end -->
 *
...
public class EnsembleOfSubsetLearners extends MultiLabelMetaLearner {
     ...
     * partition. Used when {@link #selectDiverseModels} is true.
     */
     ...
     * is used when the {@link #selectDiverseModels} parameter is 'true'.
     *
    ...
    /**
     *
     * @param selectDiverseModels whether to select most different from the
     * highly weighted partitions
     */
    ...
    /**
     *
     * @param numOfRandomPartitions number of randomly generated possible label
     * set partitions
     */
    ...
    /**
     *
     * @param numOfPartitionsForDiversity number of highly weighted partitions
     * used for selecting the 'enough' different among them
     */
    ...
    /**
     *
     * @param dynamicDiversityThreshold parameter used to dynamically define the
     * threshold of 'enough' different partition
     */
